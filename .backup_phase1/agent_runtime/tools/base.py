...
class Tool(Protocol):
    ...
    def validate_input(self, input_data: dict[str, Any], context: RuntimeContext) -> ValidationResult:
    ...
    def call(self, input_data: dict[str, Any], context: RuntimeContext) -> ToolResult:
        """Execute the tool."""
        ...
