...
class Session:
    ...
    def append_assistant_blocks(
        ...
        *,
        ...
        """Append an assistant message with explicit blocks."""
        return self.append(
            Message(
    ...
    def append_assistant_text(
        ...
        *,
        ...
        return self.append(
            Message(id=message_id or uuid4().hex, role="assistant", blocks=[make_text_block(text)], usage=usage)
        )

    def append_assistant_tool_use(
        self,
        *,
        tool_use_id: str,
        tool_name: str,
        ...
        """Append an assistant message that contains a tool-use block."""
        return self.append_assistant_blocks(
            [make_tool_use_block(tool_use_id, tool_name, input_data)],
