...
class RuntimeContext:
    ...
    def __post_init__(self) -> None:
        """Normalize the workspace root once at context creation time."""
    ...
    def is_path_within_workspace(self, path: Path) -> bool:
        """Return whether a resolved path stays inside the workspace root."""
        try:
